   ...
   app.service('FeedList', function ($rootScope, FeedLoader, $q) {
        this.get = function() {
           var deffered = $q.defer();
            var feedSources = [
            {title: 'Gary Johnson HNGN', url:     'http://www.hngn.com/rss/tags/Gary-Johnson.xml'},
			{title: 'Gary Johnson Google', url:     'http://news.google.com/news?cf=all&hl=en&pz=1&ned=us&q=Gary+Johnson&output=rss'},
			{title: 'Gary Johnson EIN', url:     'https://uspolitics.einnews.com/rss/EIn4IVrrr2mKQIag'},
        ];
        if (feeds.length === 0) {
