   ...
   app.service('FeedList', function ($rootScope, FeedLoader, $q) {
        this.get = function() {
           var deffered = $q.defer();
            var feedSources = [
            {title: 'Marco Rubio HNGN', url:     'http://www.hngn.com/rss/tags/Marco-Rubio.xml'},
			{title: 'Marco Rubio Google', url:     'http://news.google.com/news?cf=all&hl=en&pz=1&ned=us&q=Marco+Rubio&output=rss'},
			{title: 'Marco Rubio EIN', url:     'https://uspolitics.einnews.com/rss/WPGI2XhRfLv8y1K6'},
        ];
        if (feeds.length === 0) {
