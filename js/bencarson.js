...
app.service('FeedList', function($rootScope, FeedLoader, $q) {
  this.get = function() {
    ...
    var feedSources = [{
      title: 'Ben Carson HNGN',
      url: 'http://www.hngn.com/rss/tags/Ben-Carson.xml'
    }, {
      title: 'Ben Carson Google',
      url: 'http://news.google.com/news?cf=all&hl=en&pz=1&ned=us&q=Ben+Carson&output=rss'
    }, {
      title: 'Ben Carson EIN',
      url: 'https://www.einnews.com/rss/G4_fc4otrsYp8i99'
    }, ];
    if (feeds.length === 0) {
