   ...
   app.service('FeedList', function ($rootScope, FeedLoader, $q) {
        this.get = function() {
           var deffered = $q.defer();
            var feedSources = [
            {title: 'Marco Cruz HNGN', url:     'http://www.hngn.com/rss/tags/Marco-Cruz.xml'},
			{title: 'Marco Cruz Google', url:     'http://news.google.com/news?cf=all&hl=en&pz=1&ned=us&q=Marco+Cruz&output=rss'},
			{title: 'Marco Cruz EIN', url:     'https://uspolitics.einnews.com/rss/7SgWdJdMlHpRX1gw'},
        ];
        if (feeds.length === 0) {
