   ...
   app.service('FeedList', function ($rootScope, FeedLoader, $q) {
        this.get = function() {
           var deffered = $q.defer();
            var feedSources = [
            {title: 'Bernie Sanders HNGN', url:     'http://www.hngn.com/rss/tags/bernie-sanders.xml'},
			{title: 'Bernie Sanders Google', url:     'http://news.google.com/news?cf=all&hl=en&pz=1&ned=us&q=Bernie+Sanders&output=rss'},
			{title: 'Bernie Sanders EIN', url:     'https://uspolitics.einnews.com/rss/qtaV7Cl73L4tU3kX'},
        ];
        if (feeds.length === 0) {
