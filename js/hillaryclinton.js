...
app.service('FeedList', function($rootScope, FeedLoader, $q) {
  this.get = function() {
    ...
    var feedSources = [{
      title: 'Hillary Clinton HNGN',
      url: 'http://www.hngn.com/rss/tags/hillary-clinton.xml'
    }, {
      title: 'Hillary Clinton Google',
      url: 'http://news.google.com/news?cf=all&hl=en&pz=1&ned=us&q=Hillary+Clinton&output=rss'
    }, {
      title: 'Hillary Clinton EIN',
