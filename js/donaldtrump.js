...
app.service('FeedList', function($rootScope, FeedLoader, $q) {
  this.get = function() {
    ...
    var feedSources = [{
      title: 'Donald Trump HNGN',
      url: 'http://www.hngn.com/rss/tags/Donald-Trump.xml'
    }, {
      title: 'Donald Trump Google',
      url: 'http://news.google.com/news?cf=all&hl=en&pz=1&ned=us&q=Donald+Trump&output=rss'
    }, {
      title: 'Donald Trump EIN',
      url: 'https://uspolitics.einnews.com/rss/AcH-n7eBvi8DUFVb'
    }, ];
    if (feeds.length === 0) {
