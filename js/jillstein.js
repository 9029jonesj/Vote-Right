   ...
   app.service('FeedList', function ($rootScope, FeedLoader, $q) {
        this.get = function() {
           var deffered = $q.defer();
            var feedSources = [
            {title: 'Jill Stein HNGN', url:     'http://www.hngn.com/rss/tags/Jill-Stein.xml'},
			{title: 'Jill Stein Google', url:     'http://news.google.com/news?cf=all&hl=en&pz=1&ned=us&q=Jill+Stein&output=rss'},
			{title: 'Jill Stein EIN', url:     'https://www.einnews.com/rss/ozAIiQLf8wDbHZvJ'},
        ];
        if (feeds.length === 0) {
