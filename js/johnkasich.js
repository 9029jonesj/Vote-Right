   ...
   app.service('FeedList', function ($rootScope, FeedLoader, $q) {
        this.get = function() {
           var deffered = $q.defer();
            var feedSources = [
            {title: 'John Kasich HNGN', url:     'http://www.hngn.com/rss/tags/John-Kasich.xml'},
			{title: 'John Kasich Google', url:     'http://news.google.com/news?cf=all&hl=en&pz=1&ned=us&q=John+Kasich&output=rss'},
			{title: 'John Kasich EIN', url:     'https://uspolitics.einnews.com/rss/Xm6v7NyhkFGkjuxM'},
        ];
        if (feeds.length === 0) {
